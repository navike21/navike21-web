...
export const servicesEs: IService[] = [
  ...
  },
  {
    ...
    description:
      'Diseñamos y gestionamos campañas de email marketing personalizadas que fomentan la relación con tus clientes y aumentan las conversiones.',
    icon: 'RiMailLine'
  }
]
