...
export const secondaryColor: TColorConfig = {
  light: '#C684FF',
  main: '#8E33FF',
  dark: '#5119B7',
  contrastText: '#FFFFFF'
...
export const transparentSecondaryColor: TTransparentConfig = {
...
export const transparentGray: TTransparentConfig = {
...
export const infoColor: TColorConfig = {
  light: '#61F3F3',
  main: '#00B8D9',
  dark: '#006C9C',
  contrastText: '#FFFFFF'
...
export const transparentInfoColor: TTransparentConfig = {
...
export const gradientInfoColor =
  'linear-gradient(135deg, #61F3F3 0%, #00B8D9 100%)'

export const successColor: TColorConfig = {
  light: '#86E8AB',
  main: '#36B37E',
  dark: '#1B806A',
  contrastText: '#FFFFFF'
...
export const transparentSuccessColor: TTransparentConfig = {
...
export const successColorGradient =
  'linear-gradient(135deg, #86E8AB 0%, #36B37E 100%)'

export const warningColor: TColorConfig = {
  light: '#FFD666',
  main: '#FFAB00',
  dark: '#B76E00',
  contrastText: '#FFFFFF'
...
export const transparentWarningColor: TTransparentConfig = {
...
export const gradientWarningColor =
  'linear-gradient(135deg, #FFD666 0%, #FFAB00 100%)'

export const errorColor: TColorConfig = {
  light: '#FDAB76',
  main: '#FA541C',
  dark: '#B3200E',
  contrastText: '#FFFFFF'
...
export const transparentErrorColor: TTransparentConfig = {
...
export const gradientErrorColor =
