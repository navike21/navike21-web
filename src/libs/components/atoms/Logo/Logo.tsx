...
export const Logo = ({ color = PRIMARY, size = MEDIUM, className }: TLogo) => {
  const colorVariation: TColorVariation = {
    ...
    white: 'fill-white',
    black: 'fill-black',
    gray_100: 'fill-gray-100',
    gray_200: 'fill-gray-200',
    gray_300: 'fill-gray-300',
    gray_400: 'fill-gray-400',
    gray_500: 'fill-gray-500',
    gray_600: 'fill-gray-600',
    gray_700: 'fill-gray-700',
    gray_800: 'fill-gray-800',
    gray_900: 'fill-gray-900'
  }
  ...
  return (
    <svg
      ...
      className={clsx(className, sizeVariation[size])}
    >
      <path
        ...
        className={clsx(colorVariation[color])}
      />
    </svg>
  )
}
