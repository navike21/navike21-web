...
export const Instagram = ({ isColor, ...props }: ISvgProps) => (
  <svg
    viewBox="0 0 90 90"
    fill="none"
    ...
    <g mask="url(#mask0_799_5500)">
      ...
      <g filter="url(#filter0_f_799_5500)">
        <ellipse
          ...
          fill={isColor ? '#7334FF' : 'currentColor'}
        />
      </g>
      <g filter="url(#filter1_f_799_5500)">
        <circle
          ...
          cy="2.02962"
          r="47.4583"
          fill={isColor ? '#B202F5' : 'currentColor'}
        />
      </g>
      <g filter="url(#filter2_f_799_5500)">
        <circle
          ...
          cy="79.6379"
          r="26.8"
          fill={isColor ? '#FFB401' : 'currentColor'}
        />
      </g>
    </g>
    <defs>
      ...
      >
        <stop stopColor={isColor ? '#FFD502' : 'currentColor'} />
        <stop
          offset="0.869374"
          stopColor={isColor ? '#FF1154' : 'currentColor'}
        />
      </radialGradient>
    </defs>
  </svg>
